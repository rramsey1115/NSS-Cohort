...
|--|--|--|
| 1 | Bey's Blog | You will be building a modular Web application that lists of all of articles for **_Bey's Blog_** along with the authors and categories. |
| 2 | Magnum TV | **_Magnum TV_** is a new service that wil revolutionize the way people watch television. You will build a modular Web application that show the recommended shows to watch for all of the platform's users. |
