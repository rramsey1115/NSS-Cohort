...
|--|--|--|
| 1 | Khandescending Grill | The owners of **_Khandescending Grill_** have asked you to build a Web based UI that allows customers to pick which foods they want in their bowl and place an order. |
| 2 | Build a Chimera | In this fun project, you will be building a Web based UI that lets people build their own stuffed chimera for their kids. |
